...
func printValue(v any, asJSON bool) {
	...
	case PilotContractAuditSummary:
		...
		fmt.Printf("status: %s\n", x.Status)
	case EventSearchContractAuditSummary:
		fmt.Printf("Event Search contract: %s\n", x.ContractID)
		...
		fmt.Printf("runtime dependencies: %d\n", x.RuntimeDependencies)
		fmt.Printf("status: %s\n", x.Status)
	case EventInspectionContractAuditSummary:
		fmt.Printf("Event Inspection contract: %s\n", x.ContractID)
		fmt.Printf("capability: %s\n", x.Capability)
		fmt.Printf("runtime boundary: %s (%s)\n", x.RuntimeBoundary, x.RuntimeState)
		fmt.Printf("fixtures: %d (positive=%d negative=%d)\n", x.Fixtures, x.PositiveFixtures, x.NegativeFixtures)
		fmt.Printf("runtime dependencies: %d\n", x.RuntimeDependencies)
	...
	case ImplementationLedgerAuditSummary:
		...
		fmt.Printf("status: %s\n", x.Status)
	case ImplementationReadinessProgram:
		fmt.Printf("capabilities: %d\n", x.Summary.Total)
		fmt.Printf("implemented: %d\n", x.Summary.Implemented)
		fmt.Printf("ready: %d\n", x.Summary.Ready)
		fmt.Printf("blocked: %d\n", x.Summary.Blocked)
		fmt.Printf("proposed: %d\n", x.Summary.Proposed)
		fmt.Printf("decision-blocked: %d\n", x.Summary.DecisionBlocked)
		fmt.Printf("dependency-blocked: %d\n", x.Summary.DependencyBlocked)
		fmt.Printf("unscoped blocking dependencies: %d\n", x.Summary.UnscopedBlockingDependencies)
		fmt.Printf("status: %s\n", x.Status)
	case ImplementationWaveSelection:
		fmt.Printf("selection policy: %s\n", x.SelectionPolicy)
		fmt.Printf("ready candidates: %d\n", x.ReadyCandidates)
		fmt.Printf("preferred family: %s\n", x.PreferredFamily)
		fmt.Printf("capability: %s\n", x.Capability)
		fmt.Printf("name: %s\n", x.Name)
		fmt.Printf("canonical file: %s\n", x.CanonicalFile)
		fmt.Printf("status: %s\n", x.Status)
