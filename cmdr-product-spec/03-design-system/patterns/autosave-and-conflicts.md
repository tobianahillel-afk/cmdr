---
id: deprecated-pattern-autosave-and-conflicts
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: ../patterns/recovery.md
requirements:
  - REQ-UX-002
  - REQ-UX-004
---
...
[`../patterns/recovery.md`](../patterns/recovery.md)
...
Migrer les consommateurs vers `../patterns/recovery.md` et conserver les règles métier dans leur domaine propriétaire.
