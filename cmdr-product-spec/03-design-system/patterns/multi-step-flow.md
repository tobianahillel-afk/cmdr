...
Conduire une activité séquentielle avec reprise.
...
Étapes nommées, état, validation, sauvegarde, retour, abandon, résumé final.
...
Wizard pour une action simple, étapes cachées ou validation uniquement finale.
