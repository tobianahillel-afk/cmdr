---
id: deprecated-pattern-bulk-actions
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: ../components/data-table.md
requirements:
  - REQ-UX-002
  - REQ-UX-004
---
...
Migrer les consommateurs vers `../components/data-table.md` et conserver les règles métier dans leur domaine propriétaire.
