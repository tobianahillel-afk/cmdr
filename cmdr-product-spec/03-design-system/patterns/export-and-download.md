---
id: deprecated-pattern-export-and-download
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: dangerous-action.md
requirements:
  - REQ-UX-002
  - REQ-UX-004
---
...
[`dangerous-action.md`](dangerous-action.md)
...
Migrer les consommateurs vers `dangerous-action.md` et conserver les règles métier dans leur domaine propriétaire.
