---
id: deprecated-pattern-partial-success
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: recovery.md
requirements:
  - REQ-UX-002
  - REQ-UX-004
---
...
Migrer les consommateurs vers `recovery.md` et conserver les règles métier dans leur domaine propriétaire.
