---
id: deprecated-pattern-search-and-filtering
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: ../components/filters.md
requirements:
  - REQ-UX-002
  - REQ-UX-004
---
...
Migrer les consommateurs vers `../components/filters.md` et conserver les règles métier dans leur domaine propriétaire.
