---
id: deprecated-layout-table-layout
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: queue-shell.md
requirements:
  - REQ-UX-001
  - REQ-UX-002
---
...
Les consommateurs choisissent le shell `queue-shell.md` puis appliquent uniquement les adaptations prévues.
