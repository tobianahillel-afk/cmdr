---
id: deprecated-layout-application-shell
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: global-shell.md
requirements:
  - REQ-UX-001
  - REQ-UX-002
---
...
[`global-shell.md`](global-shell.md)
...
Les consommateurs choisissent le shell `global-shell.md` puis appliquent uniquement les adaptations prévues.
