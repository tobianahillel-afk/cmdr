...
Automation Designer et reviewers Assurance.

## 3. Anatomy

Library/explorer → version/environment → node canvas → Inspector/configuration → validation/test/simulation → Automation Tray.

## 4. Zones obligatoires

canvas, node palette, version, validation, errors, Inspector.

## 5. Zones optionnelles

simulation output, diff, console, Automation Tray.
...
grille sobre, connecteurs orthogonaux, alternative structurée.

## 9. Inspector

configuration du node sélectionné ; jamais une deuxième palette.

## 10. Console

output de test, erreurs et coûts ; pas terminal général.
...
standard ; compact dans node properties.

## 17. Responsive

édition complète wide ; standard limité ; compact lecture/review.
...
nodes agentiques typés, Tool Calls visibles, Human Gates explicites.
...
chatbot géant, étoiles violettes, no-code ludique, publication sans assurance.
