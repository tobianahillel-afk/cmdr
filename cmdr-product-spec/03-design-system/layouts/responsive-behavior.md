---
id: deprecated-layout-responsive-behavior
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: ../foundations/responsive.md
requirements:
  - REQ-UX-001
  - REQ-UX-002
---
...
[`../foundations/responsive.md`](../foundations/responsive.md)
...
Les consommateurs choisissent le shell `../foundations/responsive.md` puis appliquent uniquement les adaptations prévues.
