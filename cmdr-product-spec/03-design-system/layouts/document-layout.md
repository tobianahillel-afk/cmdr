---
id: deprecated-layout-document-layout
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: decision-shell.md
requirements:
  - REQ-UX-001
  - REQ-UX-002
---
...
[`decision-shell.md`](decision-shell.md)
...
Les consommateurs choisissent le shell `decision-shell.md` puis appliquent uniquement les adaptations prévues.
