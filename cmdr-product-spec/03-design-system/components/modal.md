---
id: deprecated-component-modal
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: modals.md
requirements:
  - REQ-UX-002
  - REQ-UX-003
  - REQ-UX-004
...
Migrer variants, états et usages vers `modals.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
