---
id: deprecated-component-status-badge
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: status-indicators.md
requirements:
  - REQ-UX-002
  - REQ-UX-003
  - REQ-UX-004
...
Migrer variants, états et usages vers `status-indicators.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
