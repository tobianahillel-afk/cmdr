---
id: deprecated-component-metric-card
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: ../foundations/data-visualization.md
requirements:
  - REQ-UX-002
  - REQ-UX-003
  - REQ-UX-004
...
[`../foundations/data-visualization.md`](../foundations/data-visualization.md)
...
Migrer variants, états et usages vers `../foundations/data-visualization.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
