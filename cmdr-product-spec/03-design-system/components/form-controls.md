---
id: deprecated-component-form-controls
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: inputs.md
requirements:
  - REQ-UX-002
  - REQ-UX-003
  - REQ-UX-004
...
Migrer variants, états et usages vers `inputs.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
