---
id: deprecated-component-saved-view-picker
...
Migrer variants, états et usages vers `saved-views.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
