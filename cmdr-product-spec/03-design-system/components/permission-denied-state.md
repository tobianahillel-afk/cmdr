---
id: deprecated-component-permission-denied-state
domain: 03-design-system
status: deprecated
owner: Design System Lead
updated: 2026-08-03
source-of-truth: deprecated
replaced-by: empty-states.md
requirements:
  - REQ-UX-002
  - REQ-UX-003
  - REQ-UX-004
...
Migrer variants, états et usages vers `empty-states.md` ; conserver les données et permissions chez leur propriétaire fonctionnel.
