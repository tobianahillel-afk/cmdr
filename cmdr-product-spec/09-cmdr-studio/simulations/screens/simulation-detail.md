...
updated: 2026-08-03
permissions:
  - perm.studio.simulation.read
  - perm.studio.simulation.execute
...
Exécuter et rejouer un scénario isolé.
...
Permissions référencées: `perm.studio.simulation.read`, `perm.studio.simulation.execute`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Assurance et Platform Settings sandbox.
