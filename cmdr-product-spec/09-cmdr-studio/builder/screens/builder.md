...
updated: 2026-08-03
permissions:
  - perm.studio.builder.read
  - perm.studio.artifact.manage
...
Construire un artefact Studio avec contrats, permissions et tests.
...
- [human-gate](../../../05-domain-model/objects/human-gate.md)
...
Permissions référencées: `perm.studio.builder.read`, `perm.studio.artifact.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
