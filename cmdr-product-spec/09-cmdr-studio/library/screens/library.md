...
updated: 2026-08-03
permissions:
  - perm.studio.library.read
  - perm.studio.artifact.create
...
Parcourir les artefacts Studio publiés et leur assurance.
...
- [version](../../../05-domain-model/objects/version.md)
...
Permissions référencées: `perm.studio.library.read`, `perm.studio.artifact.create`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Builder.
- Vers Govern Playbooks lorsqu’un workflow est approuvé.
