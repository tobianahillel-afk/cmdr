...
updated: 2026-08-03
permissions:
  - perm.studio.skill.read
  - perm.studio.skill.manage
...
Inspecter et versionner une Skill.
...
Permissions référencées: `perm.studio.skill.read`, `perm.studio.skill.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
