...
updated: 2026-08-03
permissions:
  - perm.studio.agent-team.read
  - perm.studio.agent-team.manage
...
Composer et inspecter une équipe d’Automation Agents.
...
Permissions référencées: `perm.studio.agent-team.read`, `perm.studio.agent-team.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Assurance et Control Room.
