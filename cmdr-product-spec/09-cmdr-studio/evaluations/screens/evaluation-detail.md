...
updated: 2026-08-03
permissions:
  - perm.studio.evaluation.read
  - perm.studio.evaluation.execute
...
Inspecter dataset, métriques, résultats et seuils.
...
Permissions référencées: `perm.studio.evaluation.read`, `perm.studio.evaluation.execute`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
