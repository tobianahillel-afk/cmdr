...
updated: 2026-08-03
permissions:
  - perm.studio.assurance.read
  - perm.studio.assurance.approve
...
Décider si une version satisfait évaluations, simulations et politiques.
...
- [simulation](../../../05-domain-model/objects/simulation.md)
...
Permissions référencées: `perm.studio.assurance.read`, `perm.studio.assurance.approve`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
