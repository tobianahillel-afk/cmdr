...
workspace: automation-agent
status: draft
owner: CMDR Studio Product Lead
updated: 2026-08-03
permissions:
  - perm.studio.automation-agent.read
  - perm.studio.automation-agent.manage
source-of-truth: screen
---
# Automation Agent Detail

## 1. Objectif

Inspecter objectif, outils, mémoire, limites et assurance d’un Automation Agent.
...
- [skill](../../../05-domain-model/objects/skill.md)
- [workflow](../../../05-domain-model/objects/workflow.md)
- [evaluation](../../../05-domain-model/objects/evaluation.md)
...
Permissions référencées: `perm.studio.automation-agent.read`, `perm.studio.automation-agent.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
