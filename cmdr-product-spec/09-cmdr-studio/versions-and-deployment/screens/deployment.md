...
Promouvoir une version vers un environnement et vérifier le résultat.
...
Permissions référencées: `perm.studio.deployment.read`, `perm.studio.deployment.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Control Room et Platform Settings environments.
