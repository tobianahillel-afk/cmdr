...
updated: 2026-08-03
permissions:
  - perm.studio.workflow.read
  - perm.studio.workflow.manage
...
Inspecter étapes, branches, Human Gates et versions.
...
Permissions référencées: `perm.studio.workflow.read`, `perm.studio.workflow.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
