...
updated: 2026-08-03
permissions:
  - perm.studio.control-room.read
  - perm.studio.deployment.manage
...
Superviser agents, équipes, workflows et déploiements.
...
- [agent-team](../../../05-domain-model/objects/agent-team.md)
- [workflow](../../../05-domain-model/objects/workflow.md)
- [deployment](../../../05-domain-model/objects/deployment.md)
...
Permissions référencées: `perm.studio.control-room.read`, `perm.studio.deployment.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Govern pour une Human Gate d’autorité.
- Vers Platform Settings pour provider/secret.
