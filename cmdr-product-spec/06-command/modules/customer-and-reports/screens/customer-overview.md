...
Présenter la situation client et lancer des rapports gouvernés.
...
Permissions référencées: `perm.command.read`, `perm.shared.report.create`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
