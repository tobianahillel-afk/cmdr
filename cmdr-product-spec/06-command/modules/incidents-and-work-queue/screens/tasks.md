...
---
# Incidents & Work Queue — Tasks

## 1. Objectif

Coordonner les tâches liées aux objets opérationnels.
...
Permissions référencées: `perm.command.read`, `perm.command.task.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers l’objet source dans son produit propriétaire.
