...
permissions:
  ...
  - perm.investigate.case.create
  - perm.govern.action-request.create
...
Fournir le dossier opérationnel canonique d’un Incident.
...
- Changer l’état
- Créer ou ouvrir un Case
- Créer une Action Request
...
- [alert](../../../../05-domain-model/objects/alert.md)
- [case](../../../../05-domain-model/objects/case.md)
- [decision](../../../../05-domain-model/objects/decision.md)
- [response-run](../../../../05-domain-model/objects/response-run.md)
- [result](../../../../05-domain-model/objects/result.md)
...
Permissions référencées: `perm.command.incident.read`, `perm.command.incident.manage`, `perm.investigate.case.create`, `perm.govern.action-request.create`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Command → Investigate avec Incident context.
- Command → Govern avec justification.
- Govern → Command avec Result.
