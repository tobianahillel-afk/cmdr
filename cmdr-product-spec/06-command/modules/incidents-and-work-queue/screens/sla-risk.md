...
---
# Incidents & Work Queue — SLA Risk

## 1. Objectif

Anticiper les dépassements de SLA et leurs causes.
...
- Examiner le risque SLA
- Créer une action de mitigation
...
- Vers Govern si une décision bloque.
- Vers Investigate si une preuve manque.
