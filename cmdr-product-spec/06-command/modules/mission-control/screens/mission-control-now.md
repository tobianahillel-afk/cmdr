...
Répondre immédiatement à « que se passe-t-il maintenant? ».
...
- Examiner le changement principal
- Ouvrir l’incident sélectionné
...
- [signal](../../../../05-domain-model/objects/signal.md)
...
Permissions référencées: `perm.command.read`, `perm.command.incident.read`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Investigate depuis un Incident ou Signal.
- Vers Govern depuis une Decision en attente.
