...
Voir les décisions qui bloquent ou modifient la situation.
...
- Ouvrir la décision
- Voir le contexte de l’incident
...
Permissions référencées: `perm.command.read`, `perm.govern.decision.read`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Govern Action Center.
- Retour Govern vers Command avec Result.
