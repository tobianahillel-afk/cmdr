...
Voir les expositions et lacunes de couverture pertinentes pour l’opération.
...
- [capability](../../../../05-domain-model/objects/capability.md)
...
Permissions référencées: `perm.command.read`, `perm.command.incident.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Platform Settings pour configuration.
- Vers Investigate pour validation.
