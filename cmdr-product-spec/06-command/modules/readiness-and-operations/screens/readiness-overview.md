...
Évaluer la préparation des personnes, données, playbooks et agents.
...
Permissions référencées: `perm.command.read`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Studio assurance.
- Vers Platform Settings health.
