...
module: endpoint-agent-fleet
workspace: fleet
status: draft
owner: Platform Settings Product Lead
updated: 2026-08-03
permissions:
  - perm.settings.endpoint-fleet.read
  - perm.settings.endpoint-fleet.manage
...
Administrer la flotte Endpoint Agent possédée par Platform Settings.
...
- [endpoint-agent](../../../05-domain-model/objects/endpoint-agent.md)
- [endpoint-policy](../../../05-domain-model/objects/endpoint-policy.md)
...
Permissions référencées: `perm.settings.endpoint-fleet.read`, `perm.settings.endpoint-fleet.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Endpoint Agent capabilities.
- Vers Govern runs.
