...
updated: 2026-08-03
permissions:
  - perm.settings.preferences.manage
...
Gérer préférences personnelles sans mélanger administration tenant.
...
- [saved-view](../../../05-domain-model/objects/saved-view.md)
...
Permissions référencées: `perm.settings.preferences.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
