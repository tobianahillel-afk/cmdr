...
updated: 2026-08-03
permissions:
  - perm.settings.retention.read
  - perm.settings.retention.manage
...
Configurer rétention, legal hold et disposition.
...
Permissions référencées: `perm.settings.retention.read`, `perm.settings.retention.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
