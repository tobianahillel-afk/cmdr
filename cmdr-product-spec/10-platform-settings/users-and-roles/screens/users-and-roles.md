...
updated: 2026-08-03
permissions:
  - perm.settings.identity.read
  - perm.settings.identity.manage
...
Administrer identités, rôles et revues d’accès.
...
Permissions référencées: `perm.settings.identity.read`, `perm.settings.identity.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Govern Authorities sans transférer l’autorité.
