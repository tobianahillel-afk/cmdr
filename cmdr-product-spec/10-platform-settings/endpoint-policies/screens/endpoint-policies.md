...
module: endpoint-policies
workspace: policies
status: draft
owner: Platform Settings Product Lead
updated: 2026-08-03
permissions:
  - perm.settings.endpoint-policy.read
  - perm.settings.endpoint-policy.manage
...
Créer, tester et déployer les politiques endpoint signées.
...
Permissions référencées: `perm.settings.endpoint-policy.read`, `perm.settings.endpoint-policy.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
