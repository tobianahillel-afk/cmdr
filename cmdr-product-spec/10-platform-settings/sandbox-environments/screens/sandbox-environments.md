...
updated: 2026-08-03
permissions:
  - perm.settings.sandbox.read
  - perm.settings.sandbox.manage
...
Administrer environnements isolés pour Investigate et Studio.
...
Permissions référencées: `perm.settings.sandbox.read`, `perm.settings.sandbox.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Investigate Sandbox et Studio Simulation.
