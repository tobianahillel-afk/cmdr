...
updated: 2026-08-03
permissions:
  - perm.settings.source.read
  - perm.settings.source.manage
...
Configurer les sources et parsers avec santé et versions.
...
- [parser](../../../05-domain-model/objects/parser.md)
...
Permissions référencées: `perm.settings.source.read`, `perm.settings.source.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Alimente Shared Search et Command.
