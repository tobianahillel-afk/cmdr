...
module: models-and-providers
workspace: models
status: draft
owner: Platform Settings Product Lead
updated: 2026-08-03
permissions:
  - perm.settings.model.read
  - perm.settings.model.manage
...
Configurer modèles et fournisseurs selon politiques de données.
...
- [model-provider](../../../05-domain-model/objects/model-provider.md)
- [secret-reference](../../../05-domain-model/objects/secret-reference.md)
...
Permissions référencées: `perm.settings.model.read`, `perm.settings.model.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
