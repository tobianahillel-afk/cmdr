...
module: secrets-and-connections
workspace: connections
status: draft
owner: Platform Settings Product Lead
updated: 2026-08-03
permissions:
  - perm.settings.secret.read-metadata
  - perm.settings.secret.manage
...
Gérer secrets référencés et connexions externes.
...
Permissions référencées: `perm.settings.secret.read-metadata`, `perm.settings.secret.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Consommé par tous produits autorisés.
