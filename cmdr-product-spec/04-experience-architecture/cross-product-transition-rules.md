---
id: deprecated-experience-cross-product-transition-rules
...
Les consommateurs migrent vers `cross-product-transitions.md` et conservent uniquement leur usage local.
