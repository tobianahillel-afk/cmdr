---
id: deprecated-transition-govern-to-command
...
L’ancien scénario `govern-to-command` devient une ligne/variante du contrat canonique ; ses parcours détaillés appartiennent à la Phase 5.
