---
id: deprecated-transition-investigate-to-govern
...
L’ancien scénario `investigate-to-govern` devient une ligne/variante du contrat canonique ; ses parcours détaillés appartiennent à la Phase 5.
