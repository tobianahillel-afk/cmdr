---
id: deprecated-transition-endpoint-agent-to-investigate
...
L’ancien scénario `endpoint-agent-to-investigate` devient une ligne/variante du contrat canonique ; ses parcours détaillés appartiennent à la Phase 5.
