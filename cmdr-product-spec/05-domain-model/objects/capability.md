...
Représenter une capacité enregistrée avec propriétaire et consommateurs.
...
- `perm.product-architecture.capability.read`
- `perm.product-architecture.capability.manage`
