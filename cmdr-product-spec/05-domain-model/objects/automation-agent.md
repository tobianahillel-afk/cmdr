...
Représenter un agent LLM/automation gouverné avec objectifs, outils, limites et assurance.
...
- `perm.cmdr-studio.automation-agent.read`
- `perm.cmdr-studio.automation-agent.manage`
