...
Représenter le résultat d’une logique de détection appliquée à la télémétrie.
...
- `perm.command.detection.read`
- `perm.command.detection.manage`
