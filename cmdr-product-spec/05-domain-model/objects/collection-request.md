...
Représenter une demande gouvernée de collecte endpoint.
...
- `perm.investigate.collection-request.read`
- `perm.investigate.collection-request.manage`
