...
Représenter l’ensemble administré des Endpoint Agents d’un tenant et environnement.
...
- `perm.platform-settings.endpoint-agent-fleet.read`
- `perm.platform-settings.endpoint-agent-fleet.manage`
