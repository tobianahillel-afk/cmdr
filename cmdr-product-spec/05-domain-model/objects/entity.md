...
Représenter un hôte, compte, IP, domaine, processus, fichier, service ou ressource identifiable.
...
- `perm.shared-capabilities.entity.read`
- `perm.shared-capabilities.entity.manage`
