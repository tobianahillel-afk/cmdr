...
Représenter une référence vers un secret sans exposer sa valeur.
...
- `perm.platform-settings.secret-reference.read`
- `perm.platform-settings.secret-reference.manage`
