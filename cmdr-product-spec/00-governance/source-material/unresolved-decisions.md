...
| OPEN-011 | Mobile forensic scope | open | Investigate Product Lead | Phase 4B.2B.3 | REQ-PROD-058 |
| OPEN-012 | Cloud analysis scope | open | Investigate Product Lead | Phase 4B.2B.3/4B.3 | REQ-PROD-059 |
...
OPEN-005 remains the unresolved umbrella for sandbox, memory, disk, filesystem, network, reverse, decompiler and debugger engine selection; no engine, tool product, image format or carving algorithm is chosen. OPEN-008 remains open for supported Endpoint platforms and filesystems. OPEN-013/014/015 remain open. OPEN-011/012 remain future. No new OPEN is created and none is closed. OPEN-009 remains the only historically resolved decision.
