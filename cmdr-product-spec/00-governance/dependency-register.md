...
| DEP-INV-MOBILE | OPEN-011 | Mobile platform/tool/acquisition delivery | scope/implementation | platform/version/tool/acquisition strategy remains unresolved; provider-neutral functional closure awaits remote verification | open | Product Architecture | before Mobile implementation, not before provider-neutral documentation | OPEN-011 | roadmap/Technique |

Eighteen decisions are open. OPEN-011 governs unresolved Mobile platform/tool/acquisition delivery; OPEN-012 governs unresolved Cloud provider/service delivery; OPEN-017 remains Detection-only; OPEN-018 governs Threat Intelligence ontology/interoperability; OPEN-019 governs Intelligence dissemination/releasability/sharing/access. Phase 4B.4A remains verified PASS. Phase 4B.4B is **PENDING POST-PUBLICATION VERIFICATION**. Phase 4B.4 and Phase 4B remain PARTIAL until Mobile remote verification completes.
