...
type: screen
product: investigate
module: disk-and-artifact-forensics
workspace: disk
status: draft
owner: Investigate Product Lead
updated: 2026-08-03
permissions:
  - perm.investigate.analysis.execute
...
Analyser en lecture seule une Disk Image et ses artefacts.
...
- [disk-image](../../../../05-domain-model/objects/disk-image.md)
- [artifact](../../../../05-domain-model/objects/artifact.md)
- [evidence](../../../../05-domain-model/objects/evidence.md)
- [timeline-entry](../../../../05-domain-model/objects/timeline-entry.md)
...
Permissions référencées: `perm.investigate.analysis.execute`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
