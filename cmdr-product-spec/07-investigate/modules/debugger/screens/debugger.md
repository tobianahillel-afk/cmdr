...
updated: 2026-08-03
permissions:
  - perm.investigate.debugger.execute
...
Exécuter run, pause et step dans un environnement d’analyse isolé.
...
Permissions référencées: `perm.investigate.debugger.execute`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
