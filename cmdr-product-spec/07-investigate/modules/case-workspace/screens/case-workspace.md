...
Fournir le workspace durable d’un Case.
...
- [entity](../../../../05-domain-model/objects/entity.md)
...
Permissions référencées: `perm.investigate.case.read`, `perm.investigate.case.manage`, `perm.investigate.finding.author`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Retour vers Incident Command.
- Finding confirmé → Govern.
