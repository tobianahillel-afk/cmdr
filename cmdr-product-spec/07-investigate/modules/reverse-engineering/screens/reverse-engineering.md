...
updated: 2026-08-03
permissions:
  - perm.investigate.reverse.execute
...
Désassembler, décompiler et annoter un binaire.
...
- Naviguer vers une fonction
- Annoter
- Créer un artefact dérivé
...
Permissions référencées: `perm.investigate.reverse.execute`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
