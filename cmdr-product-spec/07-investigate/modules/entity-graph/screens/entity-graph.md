...
permissions:
  ...
  - perm.investigate.entity.manage
...
Explorer des relations sourcées sans inférer la causalité par la mise en page.
...
Permissions référencées: `perm.investigate.case.read`, `perm.investigate.entity.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
