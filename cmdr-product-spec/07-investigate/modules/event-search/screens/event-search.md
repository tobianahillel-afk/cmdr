...
permissions:
  ...
  - perm.investigate.evidence.collect
  - perm.investigate.evidence.export
...
Rechercher la télémétrie SIEM et promouvoir des résultats vers le Case.
...
- [telemetry-event](../../../../05-domain-model/objects/telemetry-event.md)
- [query](../../../../05-domain-model/objects/query.md)
- [search-job](../../../../05-domain-model/objects/search-job.md)
...
Permissions référencées: `perm.investigate.search.execute`, `perm.investigate.evidence.collect`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Depuis Case Workspace.
- Vers Evidence et Entity Graph.
