---
id: CAP-INV-519
title: Intelligence Analysis Intake and Session Management
product: investigate
...
---
# CAP-INV-519 — Intelligence Analysis Intake and Session Management

## 1. Définition
Ouvrir un Analysis Handoff Package ou un contexte autorisé et gérer une Intelligence Analysis Session sans produire silencieusement un assessment final.

## 2. Problème utilisateur
Un handoff incomplet peut être traité comme une analyse terminée ou perdre son origine.

## 3. Objectifs
- ouvrir depuis Handoff, Knowledge Project, Case, Hunt ou Detection Engineering.
- définir question, scope, owner et contributeurs.
- suspendre, reprendre, clôturer, rouvrir, archiver et superseder en conservant le retour.
...
## 6. Utilisateurs
Principal : **Threat Intelligence Analyst**. Secondaires : Threat Intelligence Analyst, Senior Intelligence Analyst, Intelligence Manager, SOC Analyst, Detection Engineer, Incident Commander, Investigation Lead, Consumer Reviewer, Approver et Auditor autorisés selon le scope.
...
|---|---|---|---:|---|---|
| Analysis Handoff Package | capability/source owner | versioned context | oui | selected version | état incomplete ou blocked |
| Knowledge Project / Case / Hunt / Detection context | linked owner | supporting context | selon scope | declared period | partialité visible |
...
|---|---|---|---|
| Analysis Handoff Package | source owner | authorized version and provenance | lecture/lien |
| Intelligence Requirement | source owner | context, alternatives and limits | lecture/comparaison |
| Source and candidate projections | source owner | supporting projection | lecture limitée |

## 10. Objets créés ou modifiés
| Objet | Opération | Propriétaire | Règle |
|---|---|---|---|
| Intelligence Analysis Session | créer, annoter, versionner, contester, superseder | Investigate concept | réversible, sourcé et non exécutoire |
| Session membership and disposition | créer ou mettre à jour | Investigate concept / destination owner | aucune mutation silencieuse |
...
|---|---|---|---:|---|---|---|
| consulter, filtrer, rechercher, comparer | Threat Intelligence Analyst | sources et projections | 0 | lecture autorisée | vue sourcée et permission-aware | non |
| exécuter analyse, comparaison ou génération bornée | Threat Intelligence Analyst | résultat analytique / Tool Call | 1 | scope et restrictions visibles | résultat attribué, partialité et erreurs visibles | selon politique |
| créer, revoir, publier internement de façon réversible ou préparer un handoff | Threat Intelligence Analyst | concept Intelligence Analysis Intake and Session Management | 2 | owner, provenance et séparation explicites | version ou proposition non effective hors scope | OPEN-013/019 |
...
|---|---:|---:|---:|---:|---|
| préparer Intelligence Analysis Intake and Session Management | oui | formulaires, matrices et règles explicables | oui | draft sourcé | formulaire structuré et checklist |
...
`draft`, `incomplete`, `ready`, `active`, `paused`, `blocked`, `partial`, `completed-analysis`, `failed`, `archived`, `superseded`. Ces états sont des projections fonctionnelles versionnées, pas une machine d’état canonique finale.
...
|---|---|---|---|
| Analysis Session | versioned concept | downstream capability / owner | sources, versions, restrictions et incertitude visibles |
| Session lifecycle event | business event or package | reviewer / consumer | aucun effet externe implicite |

## 17. Transitions
| Source | Déclencheur | Destination | Contexte transmis | Retour |
|---|---|---|---|---|
| CAP-INV-518 | handoff opened | CAP-INV-519 | package, versions, restrictions and return origin | Handoff |
| Knowledge Project | analysis requested | CAP-INV-519 | requirements, scope, owner and sources | Project |
| CAP-INV-519 | question ready | CAP-INV-520 | session, question, sources and gaps | Session |
...
## 18. Dépendances
CAP-INV-501..518; Cases/Hunts; Detection Engineering; Shared Versioning/Collaboration; OPEN-013/018/019. Shared est consommé sans redéfinition. Aucun protocole, moteur, provider ou format externe n’est choisi.
...
|---|---|---:|---|---|---|---|---|
| Analysis Session create/update/close/reopen | cross-context scope and premature closure | 2 | restricted sources masked | OPEN-013 | author/reviewer | Investigate / source owner | Permissions |
...
- Handoff Package ≠ Session.
- completed-analysis ≠ final published assessment.
...
- sessions by state and origin.
- sessions preserving return origin.
- silent final assessments — target zero.
...
**Given** un contexte de Intelligence Analysis Intake and Session Management avec sources ou permissions manquantes  
**When** Threat Intelligence Analyst tente de poursuivre  
