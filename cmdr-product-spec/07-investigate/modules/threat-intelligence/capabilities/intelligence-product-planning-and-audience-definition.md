---
id: CAP-INV-525
title: Intelligence Product Planning and Audience Definition
product: investigate
...
---
# CAP-INV-525 — Intelligence Product Planning and Audience Definition

## 1. Définition
Planifier un Intelligence Product en reliant Requirements, question, objectif, type fonctionnel, audience, détail, temporalité, sources, assessments, reviewers, markings et releasability candidate.

## 2. Problème utilisateur
Un produit peut être rédigé sans audience, finalité, sources ou restrictions explicites.
...
## 6. Utilisateurs
Principal : **Intelligence Manager**. Secondaires : Threat Intelligence Analyst, Senior Intelligence Analyst, Intelligence Manager, SOC Analyst, Detection Engineer, Incident Commander, Investigation Lead, Consumer Reviewer, Approver et Auditor autorisés.
...
|---|---|---|---:|---|---|
| Requirements and analytical question | CAP-INV-502/520 | need and question | oui | selected/current version | partialité ou blocage visible |
| Assessments and limitations | CAP-INV-522..524 | judgments and constraints | selon scope | selected/current version | partialité ou blocage visible |
...
|---|---|---|---|
| Intelligence Requirements | Investigate | criteria and unresolved questions | lecture/lien limité |
| Audience/consumer projections | Settings / product owners | authorized groups and constraints | lecture/lien limité |
| Trace and versions | Shared | lineage and comparison | lecture |

## 10. Objets créés ou modifiés
| Objet | Opération | Propriétaire | Règle |
|---|---|---|---|
| Intelligence Product Plan | créer, annoter, contester, versionner, retirer, superseder | Investigate concept | réversible et sourcé |
| Audience Definition | créer ou mettre à jour | Investigate concept / destination owner | aucune mutation silencieuse |
...
|---|---|---|---:|---|---|---|
| consulter, filtrer, rechercher, comparer | Intelligence Manager | sources et projections | 0 | lecture autorisée | vue sourcée | non |
| exécuter analyse/comparaison/génération bornée | Intelligence Manager | résultat / Tool Call | 1 | scope visible | résultat attribué avec erreurs | selon politique |
| créer, revoir, versionner ou préparer un handoff | Intelligence Manager | Intelligence Product Plan | 2 | owner et provenance explicites | version/proposition réversible | OPEN-013/019 |
...
|---|---:|---:|---:|---:|---|
| préparer Intelligence Product Planning and Audience Definition | oui | formulaires, matrices, règles explicables | oui | draft sourcé | formulaire et checklist |
...
`draft`, `incomplete`, `planning`, `ready-for-authoring`, `paused`, `blocked`, `superseded`, `withdrawn`. États fonctionnels versionnés, non machine d’état canonique finale.
...
|---|---|---|---|
| Intelligence Product Plan | concept versionné | capability/owner suivant | sources, restrictions et incertitude visibles |
| Audience Definition | événement ou package | reviewer/consumer | aucun effet externe implicite |

## 17. Transitions
| Source | Déclencheur | Destination | Contexte transmis | Retour |
|---|---|---|---|---|
| CAP-INV-522..524 | assessment ready | CAP-INV-525 | assessment, sources, confidence and limits | Assessment |
| CAP-INV-502 | Requirement selected | CAP-INV-525 | criteria, audience need and due date | Requirement |
| CAP-INV-525 | plan ready | CAP-INV-526 | plan, audience, structure and restrictions | Plan |
...
|---|---|---:|---|---|---|---|---|
| Product Plan create/update | mis-scoped audience or unsupported product | 2 | sources/identités/données restreintes masquées | OPEN-013 | auteur/reviewer | Investigate / source owner | Permissions |
...
- Audience ≠ technical recipient list.
- Product Plan ≠ published product.
- Strategic, operational and tactical are functional types, not formats.
...
**When** Intelligence Manager poursuit  
