---
id: CAP-INV-520
title: Intelligence Questions, Hypotheses and Competing Assessments
product: investigate
...
---
# CAP-INV-520 — Intelligence Questions, Hypotheses and Competing Assessments

## 1. Définition
Formuler des questions, hypothèses nulles et concurrentes, conditions favorables, contradictions et données manquantes dans une Session.

## 2. Problème utilisateur
Une hypothèse soutenue peut être présentée comme fait et les alternatives supprimées.

## 3. Objectifs
- définir question, hypothèse nulle et explications alternatives.
- lier Requirements, sources, Sightings et assessments.
- comparer, contester, réviser, retirer et superseder.
...
|---|---|---|---:|---|---|
| Intelligence Analysis Session | capability/source owner | versioned context | oui | selected version | état incomplete ou blocked |
| Requirements, sources, Sightings and assessments | linked owner | supporting context | selon scope | declared period | partialité visible |
...
|---|---|---|---|
| Analysis Session | source owner | authorized version and provenance | lecture/lien |
| Intelligence Requirement | source owner | context, alternatives and limits | lecture/comparaison |
| Foundation assessments | source owner | supporting projection | lecture limitée |

## 10. Objets créés ou modifiés
| Objet | Opération | Propriétaire | Règle |
|---|---|---|---|
| Intelligence Analysis Question | créer, annoter, versionner, contester, superseder | Investigate concept | réversible, sourcé et non exécutoire |
| Intelligence Hypothesis | créer ou mettre à jour | Investigate concept / destination owner | aucune mutation silencieuse |
...
| créer, revoir, publier internement de façon réversible ou préparer un handoff | Senior Intelligence Analyst | concept Intelligence Questions, Hypotheses and Competing Assessments | 2 | owner, provenance et séparation explicites | version ou proposition non effective hors scope | OPEN-013/019 |
...
|---|---:|---:|---:|---:|---|
| préparer Intelligence Questions, Hypotheses and Competing Assessments | oui | formulaires, matrices et règles explicables | oui | draft sourcé | formulaire structuré et checklist |
...
`proposed`, `under-analysis`, `supported`, `weakly-supported`, `contradicted`, `inconclusive`, `insufficient-information`, `disputed`, `superseded`, `withdrawn`. Ces états sont des projections fonctionnelles versionnées, pas une machine d’état canonique finale.
...
|---|---|---|---|
| Competing Assessment | versioned concept | downstream capability / owner | sources, versions, restrictions et incertitude visibles |
| Hypothesis review event | business event or package | reviewer / consumer | aucun effet externe implicite |

## 17. Transitions
| Source | Déclencheur | Destination | Contexte transmis | Retour |
|---|---|---|---|---|
| CAP-INV-519 | session active | CAP-INV-520 | question, scope and source set | Session |
| Candidates | explanation proposed | CAP-INV-520 | candidate versions, support and contradictions | Candidate |
| CAP-INV-520 | structured comparison needed | CAP-INV-521 | hypotheses, claims, gaps and dependencies | Hypothesis |
...
## 18. Dépendances
CAP-INV-502/515/519/521; Shared Comparison; OPEN-013/018/019. Shared est consommé sans redéfinition. Aucun protocole, moteur, provider ou format externe n’est choisi.
...
|---|---|---:|---|---|---|---|---|
| Hypothesis create/update/review | false certainty and confirmation bias | 2 | restricted claims masked | OPEN-013 | analyst/reviewer | Investigate / source owner | Permissions |
...
- supported hypothesis ≠ fact.
- competing hypothesis ≠ contradiction.
- Intelligence Hypothesis ≠ Case or Detection Hypothesis.
...
- silent hypothesis confirmation — target zero.
...
**Given** un contexte de Intelligence Questions, Hypotheses and Competing Assessments avec sources ou permissions manquantes  
