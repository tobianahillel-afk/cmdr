...
updated: 2026-08-03
permissions:
  - perm.investigate.sandbox.execute
...
Capturer le comportement d’un artefact en environnement isolé.
...
- [malware-sample](../../../../05-domain-model/objects/malware-sample.md)
- [sandbox-environment](../../../../05-domain-model/objects/sandbox-environment.md)
...
Permissions référencées: `perm.investigate.sandbox.execute`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Reverse, Memory et Finding.
