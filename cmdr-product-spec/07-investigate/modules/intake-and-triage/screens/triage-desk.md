...
Intégrer les nouveaux Cases et choisir un plan d’investigation.
...
- [collection-request](../../../../05-domain-model/objects/collection-request.md)
...
Permissions référencées: `perm.investigate.case.read`, `perm.investigate.case.create`, `perm.investigate.evidence.collect`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Command → Investigate depuis Incident.
- Vers Case Workspace.
