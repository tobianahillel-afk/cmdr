...
type: screen
product: investigate
module: hypotheses-and-findings
workspace: reasoning
status: draft
owner: Investigate Product Lead
updated: 2026-08-03
permissions:
  - perm.investigate.finding.author
  - perm.investigate.finding.approve
...
Passer d’hypothèses testables à des Findings revus.
...
- Créer une Hypothesis
- Ajouter pour/contre
- Soumettre le Finding
...
- [hypothesis](../../../../05-domain-model/objects/hypothesis.md)
...
Permissions référencées: `perm.investigate.finding.author`, `perm.investigate.finding.approve`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Finding confirmé → Govern Action Request.
