...
Construire une chronologie observée et inférée avec provenance.
...
Permissions référencées: `perm.investigate.case.read`, `perm.investigate.case.manage`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
