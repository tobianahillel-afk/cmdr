...
permissions:
  ...
  - perm.investigate.evidence.verify
...
Organiser et vérifier les Evidence et leurs relations.
...
Permissions référencées: `perm.investigate.evidence.read`, `perm.investigate.evidence.collect`, `perm.investigate.evidence.verify`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
