...
updated: 2026-08-03
permissions:
  - perm.investigate.report.manage
...
Composer et publier un rapport d’investigation reproductible.
...
Permissions référencées: `perm.investigate.report.manage`, `perm.investigate.evidence.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
