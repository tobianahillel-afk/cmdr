...
Explorer les activités gouvernées et vérifier leur intégrité.
...
- [local-audit-event](../../../../05-domain-model/objects/local-audit-event.md)
...
Permissions référencées: `perm.security.audit.read`, `perm.security.audit.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Liens vers tous les produits selon permission.
