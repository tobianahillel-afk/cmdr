...
permissions:
  ...
  - perm.govern.response-run.execute
  - perm.govern.response-run.rollback
...
Superviser l’exécution, les résultats partiels et le rollback.
...
- [response-step](../../../../05-domain-model/objects/response-step.md)
- [response-rollback](../../../../05-domain-model/objects/response-rollback.md)
...
Permissions référencées: `perm.govern.response-run.read`, `perm.govern.response-run.execute`, `perm.govern.response-run.rollback`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Endpoint Agent exécute localement.
- Result → Command.
