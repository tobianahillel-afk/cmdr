...
updated: 2026-08-03
permissions:
  - perm.govern.policy.read
  - perm.govern.policy.manage
...
Créer, tester et activer des Policy Gates explicables.
...
Permissions référencées: `perm.govern.policy.read`, `perm.govern.policy.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Platform Settings secrets/connections si dépendance.
