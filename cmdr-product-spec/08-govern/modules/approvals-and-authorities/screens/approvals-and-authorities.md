...
updated: 2026-08-03
permissions:
  - perm.govern.authority.read
  - perm.govern.authority.manage
...
Administrer l’autorité de décision sans confondre rôles et permissions ordinaires.
...
- [role](../../../../05-domain-model/objects/role.md)
- [approval](../../../../05-domain-model/objects/approval.md)
...
Permissions référencées: `perm.govern.authority.read`, `perm.govern.authority.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Vers Platform Settings users and roles.
