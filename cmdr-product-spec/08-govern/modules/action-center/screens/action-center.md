...
Prendre une Decision informée avec impact, conditions et rollback visibles.
...
- [action-request](../../../../05-domain-model/objects/action-request.md)
- [finding](../../../../05-domain-model/objects/finding.md)
- [decision](../../../../05-domain-model/objects/decision.md)
- [playbook](../../../../05-domain-model/objects/playbook.md)
- [policy](../../../../05-domain-model/objects/policy.md)
...
Permissions référencées: `perm.govern.action-request.read`, `perm.govern.decision.approve`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Depuis Investigate Finding.
- Decision → Response Run.
- Retour Result → Command.
