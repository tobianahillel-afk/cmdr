...
Consulter le registre immuable et les supersessions.
...
Permissions référencées: `perm.govern.decision.read`, `perm.security.audit.export`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
