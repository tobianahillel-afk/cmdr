...
updated: 2026-08-03
permissions:
  - perm.govern.playbook.read
  - perm.govern.playbook.manage
...
Gérer les Playbooks publiés utilisables par les Response Runs.
...
- [workflow](../../../../05-domain-model/objects/workflow.md)
...
Permissions référencées: `perm.govern.playbook.read`, `perm.govern.playbook.manage`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
...
- Studio fournit Workflow/Skills; Govern publie le Playbook de réponse.
