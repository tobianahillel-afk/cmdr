...
Mesurer décision, exécution, exceptions, partial success et rollback.
...
Permissions référencées: `perm.govern.metrics.read`, `perm.shared.report.create`. La source unique est `14-security-permissions-and-trust/permission-model.md`.
